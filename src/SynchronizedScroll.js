...
var barRenderer = new Charting.BarRenderer(
				new Collections.ObservableCollection([
		new Charting.Series2D(
			new Collections.List([1, 2, 3, 4, 5, 6, 7]),
			new Collections.List([20.3, 12, 73.23, 21.2, 72, 66, 42.239]),
			null),
		new Charting.Series2D(
			new Collections.List([1, 2, 3, 4, 5, 6, 7]),
			new Collections.List([22.3, 15, 43.23, 11.2, 32, 12, 62.239]),
			null
		)]));
...
var lineRenderer = new Charting.CurveAreaRenderer(
		...
		new Charting.Series2D(
			new Collections.List([1, 2, 3, 4, 5, 6, 7]),
			new Collections.List([10.3, 22, 33.23, 41.2, 12, 26, 42.239]),
			null),
		new Charting.Series2D(
			new Collections.List([1, 2, 3, 4, 5, 6, 7]),
			new Collections.List([42.3, 45, 43.23, 21.2, 12, 22, 22.239]),
			null
		)]));

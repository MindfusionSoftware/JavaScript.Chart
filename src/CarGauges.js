...
var speedometer = Gauges.OvalGauge.create(document.getElementById('speedometer'), false);
...
var cyclometer = Gauges.OvalGauge.create(document.getElementById('cyclometer'), false);
...
var batteryMeter = Gauges.OvalGauge.create(document.getElementById('batteryMeter'), false);
...
var oilMeter = Gauges.OvalGauge.create(document.getElementById('oilMeter'), false);
...
// kphScale
var kphScale = new OvalScale(speedometer);
kphScale.minValue = (0);
...
var majorSettings = kphScale.majorTickSettings;
...
// fuelScale
var fuelScale = new Gauges.OvalScale(speedometer);
...
// outer scale
var outerScale = new Gauges.OvalScale(speedometer);
...
// mph scale
var mphScale = new Gauges.OvalScale(speedometer);
mphScale.minValue = (0);
...
// batteryMeter
// batteryScale
var batteryScale = new Gauges.OvalScale(batteryMeter);
...
// oilMeter
// oilScale
var oilScale = new Gauges.OvalScale(oilMeter);
oilScale.minValue = (0);
...
function speedChanged()
{
	...
	var speedPointer = speedometer.getElementByName("speedPointer");
...
function fuelChanged()
{
	if (isNaN(this.value)) return;
	var speedometer = Gauges.OvalGauge.find('speedometer');
	var fuelPointer = speedometer.getElementByName("fuelPointer");

...
document.getElementById('lin').addEventListener("click", function () { typeChanged(this.value) });
document.getElementById('log').addEventListener("click", function () { typeChanged(this.value) });
document.getElementById('custom').addEventListener("click", function () { typeChanged(this.value) });
...
var os = new Gauges.OvalScale(gauge);
...
function onPrepaintBackground(sender, args)
{
	...
	var baseShape = new Gauges.PathFigure(figurePath);
...
function onPrepaintForeground(sender, args)
{
	...
	//Reflection 1
	var figure1 = new Gauges.PathFigure(
	...
	//Reflection 2
	var figure2 = new Gauges.PathFigure(
